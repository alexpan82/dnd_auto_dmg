...
Rolling for damage / effects in DnD combat is infamously complex and slows down the game. The traditional solution to use an online resource such as DnD Beyond / Roll20 still the burden the player with manual damage roll clicks and require them to have perfect knowledge of their character stats and feats. Additionally these systems are not flexible to homebrew mechanics / items. They also take away from the player experience by unintentionally promoting online distractions which makes it difficult for players to be "present" during the session. 
